...
var RoleModel = /** @class */ (function () {
    ...
    RoleModel.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RoleModel.findByName = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.pool.execute("SELECT * FROM ".concat(this.tableName, " WHERE name = ?"), [name])];
                    case 1:
                        rows = (_a.sent())[0];
                        return [2 /*return*/, rows[0] || null];
                }
    ...
    RoleModel.create = function (roleData) {
        return __awaiter(this, void 0, void 0, function () {
            var result, insertedId, createdItem;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.pool.execute("INSERT INTO ".concat(this.tableName, " (name, description, permissions)\n       VALUES (?, ?, ?)"), [
                            roleData.name,
    ...
    RoleModel.update = function (id, roleData) {
        return __awaiter(this, void 0, void 0, function () {
            var updates, values;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RoleModel.getRolePermissions = function (roleId) {
        return __awaiter(this, void 0, void 0, function () {
            var role;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findById(roleId)];
                    case 1:
                        role = _a.sent();
                        return [2 /*return*/, role ? role.permissions : []];
                }
            });
        });
    };
