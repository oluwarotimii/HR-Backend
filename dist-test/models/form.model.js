...
var FormModel = /** @class */ (function () {
    ...
    FormModel.findAll = function (branchId) {
    ...
    FormModel.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FormModel.findByType = function (formType, branchId) {
        return __awaiter(this, void 0, void 0, function () {
            var query, params, rows;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = "SELECT * FROM ".concat(this.tableName, " WHERE form_type = ?");
                        params = [formType];
                        if (branchId) {
                            query += ' AND branch_id = ?';
    ...
    FormModel.create = function (formData) {
        return __awaiter(this, void 0, void 0, function () {
            var result, insertedId, createdItem;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.pool.execute("INSERT INTO ".concat(this.tableName, " (name, description, form_type, branch_id, created_by) \n       VALUES (?, ?, ?, ?, ?)"), [
                            formData.name,
    ...
    FormModel.update = function (id, formData) {
        return __awaiter(this, void 0, void 0, function () {
            var updates, values;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FormModel.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.pool.execute("UPDATE ".concat(this.tableName, " SET is_active = FALSE WHERE id = ?"), [id])];
                    case 1:
                        result = _a.sent();
