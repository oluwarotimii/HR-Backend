...
import timeOffProgramRoutes from './api/time-off-program.route';
...
import floatingDayRoutes from './api/floating-day.route';
...
app.use('/api/time-off-programs', timeOffProgramRoutes);
...
app.use('/api/floating-days', floatingDayRoutes);
