...
// Create a final corrected Postman collection with accurate endpoints
const finalCollection = {
  "info": {
    "_postman_id": "hr-management-full-api-final",
    "name": "HR Management System - Complete API Collection (FINAL)",
...
// Write the final corrected collection
const outputPath = path.join(__dirname, 'hr_management_system_final_corrected_api.postman_collection.json');
fs.writeFileSync(outputPath, JSON.stringify(finalCollection, null, 2));

console.log('Final corrected HR Management System Postman collection created successfully!');
